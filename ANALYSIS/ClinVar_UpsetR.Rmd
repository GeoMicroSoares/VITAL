---
title: "VITAL - ClinVar - Data Analysis"
author: "André Soares"
date: "02/05/2020"
output: 
  html_document:
...
## Filtered data analysis
 ...
 - Using column "ALLELEID clinvar_20191118.vcf" as it should provide an individual ID to each allele found.
...
ctrl_sv = mVITAL$`CLNDISDB clinvar_20191118.vcf`[mVITAL$Phenotype == "Control"]
#remove rows 
f_mVITAL <- filter(mVITAL, !`CLNDISDB clinvar_20191118.vcf` %in% ctrl_sv)
